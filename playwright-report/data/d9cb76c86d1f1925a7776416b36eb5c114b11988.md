...
- Name: Contact Form Tests >> should show validation error for invalid email
- Location: C:\Users\kenneth\Desktop\agence_web\tests\ui\contact-form.spec.js:43:3
...
Call log:
  ...
  - waiting for locator('.alert-danger')
    ...
    at C:\Users\kenneth\Desktop\agence_web\tests\ui\contact-form.spec.js:62:49
```
...
- combobox "Type de besoin *":
  - option "Sélectionnez le type de projet"
  - option "Développement" [selected]
  - option "Maintenance"
  - option "Conseil"
  - option "Autre"
- text: Message *
