...
- Name: Navigation Tests >> should display all technologies
- Location: C:\Users\kenneth\Desktop\agence_web\tests\ui\navigation.spec.js:64:3

# Error details

```
Error: expect.toContainText: Error: strict mode violation: locator('#technologies h5') resolved to 8 elements:
    1) <h5>PHP</h5> aka getByRole('heading', { name: 'PHP', exact: true })
    2) <h5>Laravel</h5> aka getByRole('heading', { name: 'Laravel' })
    3) <h5>Symfony</h5> aka getByRole('heading', { name: 'Symfony' })
    4) <h5>MySQL</h5> aka getByRole('heading', { name: 'MySQL' })
    5) <h5>Vue.js/React</h5> aka getByRole('heading', { name: 'Vue.js/React' })
    6) <h5>Docker</h5> aka getByRole('heading', { name: 'Docker' })
    7) <h5>Git</h5> aka getByRole('heading', { name: 'Git' })
    8) <h5>Composer/Packagist</h5> aka getByRole('heading', { name: 'Composer/Packagist' })

Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('#technologies h5')

    at C:\Users\kenneth\Desktop\agence_web\tests\ui\navigation.spec.js:74:54
```
