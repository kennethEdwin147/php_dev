...
- Name: Modal Popup Tests >> should open modal when clicking "Demander un Devis" in navbar
- Location: C:\Users\kenneth\Desktop\agence_web\tests\ui\modal.spec.js:4:3
...
Locator: locator('#modal-devis-title')
Expected string: "Contactez-moi directement"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('#modal-devis-title')

    at C:\Users\kenneth\Desktop\agence_web\tests\ui\modal.spec.js:18:54
```
