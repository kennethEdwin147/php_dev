...
- Name: Navigation Tests >> should display all service cards
- Location: C:\Users\kenneth\Desktop\agence_web\tests\ui\navigation.spec.js:44:3

# Error details

```
Error: expect.toContainText: Error: strict mode violation: locator('.card-footer h3') resolved to 5 elements:
    1) <h3 class="fs-5 text-green">Développement de Portails Sécurisés</h3> aka getByRole('heading', { name: 'Développement de Portails Sé' })
    2) <h3 class="fs-5 text-green">Applications Web Sur Mesure</h3> aka getByRole('heading', { name: 'Applications Web Sur Mesure' })
    3) <h3 class="fs-5 text-green">Maintenance & Évolution</h3> aka getByRole('heading', { name: 'Maintenance & Évolution' })
    4) <h3 class="fs-5 text-green">Intégration d'API & Systèmes Tiers</h3> aka getByRole('heading', { name: 'Intégration d\'API & Systèmes' })
    5) <h3 class="fs-5 text-green">Conseil Technique & Architecture Logicielle</h3> aka getByRole('heading', { name: 'Conseil Technique &' })

Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('.card-footer h3')

    at C:\Users\kenneth\Desktop\agence_web\tests\ui\navigation.spec.js:60:53
```
