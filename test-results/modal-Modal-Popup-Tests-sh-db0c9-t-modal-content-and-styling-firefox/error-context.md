...
- Name: Modal Popup Tests >> should display correct modal content and styling
- Location: C:\Users\kenneth\Desktop\agence_web\tests\ui\modal.spec.js:92:3
...
Locator: locator('#modal-devis .bi-telephone')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('#modal-devis .bi-telephone')

    at C:\Users\kenneth\Desktop\agence_web\tests\ui\modal.spec.js:100:62
```
